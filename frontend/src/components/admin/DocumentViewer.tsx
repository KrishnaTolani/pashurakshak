...
const DocumentViewer: React.FC<DocumentViewerProps> = ({ url, title, onClose }) => {
    ...
    const processCloudinaryUrl = (inputUrl: string): string => {
        try {
            ...
            if (
                inputUrl.includes('res-console.cloudinary.com') ||
                ...
                if (cloudName && publicId) {
                    console.log(
                        `Transformed console URL to: https://res.cloudinary.com/${cloudName}/image/upload/${publicId}`
                    );
            ...
            if (inputUrl.includes('res.cloudinary.com') && inputUrl.includes('/image/upload/')) {
                    ...
                    {hasError ? (
                        <div className="flex flex-col items-center justify-center text-red-500 p-8 bg-white dark:bg-card-dark rounded-lg">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-4 text-center max-w-md">
                                The image could not be displayed. This might be due to an invalid
                                URL or unsupported format.
                            </p>
