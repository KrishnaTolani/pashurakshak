        ...
        <div className="relative p-8 bg-white dark:bg-card-dark rounded-2xl border-2 border-primary-200/80 dark:border-theme-heart/10 shadow-xl backdrop-blur-sm">
          ...
          <div className="mt-6 space-y-8">
            <div className="flex items-baseline justify-between border-b border-dashed border-primary-200 dark:border-theme-heart/20 pb-4">
              <span className="text-sm text-muted-foreground/80 dark:text-foreground-dark/60">Mission ID:</span>
            ...
            <div className="relative">
              <div className="text-center space-y-2">
                <div className="inline-flex items-center gap-3 px-4 py-2 bg-primary-50 dark:bg-theme-heart/5 rounded-lg border border-primary-100 dark:border-theme-heart/10">
                  ...
                  <span className="text-sm font-medium text-primary-600 dark:text-theme-heart">Search in Progress</span>
                </div>
                <h1 className="text-7xl font-black tracking-tighter">
                  <span className="bg-gradient-to-r from-primary-600 to-theme-paw dark:from-theme-nature dark:to-theme-paw bg-clip-text text-transparent">4</span>
                  <span className="relative mx-2 text-theme-heart animate-pulse">0</span>
                  <span className="bg-gradient-to-r from-theme-paw to-theme-heart bg-clip-text text-transparent">4</span>
                </h1>
              </div>
            </div>
            ...
            <div className="space-y-4 font-mono text-sm">
              <div className="p-4 bg-primary-50/50 dark:bg-white/5 rounded-lg border border-primary-100/50 dark:border-theme-heart/10">
                <p className="text-primary-700/90 dark:text-foreground-dark/60">
                  <span className="text-theme-heart font-semibold">[ERROR]</span> Page location unknown
                </p>
                <p className="text-primary-700/90 dark:text-foreground-dark/60">
                  <span className="text-primary-600 dark:text-theme-paw font-semibold">[STATUS]</span> Search party deployed
                </p>
                <p className="text-primary-700/90 dark:text-foreground-dark/60">
                  <span className="text-theme-nature font-semibold">[UPDATE]</span> Still searching...
                </p>
              </div>
            </div>
