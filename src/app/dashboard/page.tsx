...
export default function DashboardPage() {
  return (
    <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground dark:text-gray-400">
              Welcome to your animal rescue management dashboard
            </p>
          </div>
      ...
      <div className="relative">
        <div className="absolute -inset-0.5 bg-gradient-to-r from-theme-nature via-theme-paw to-theme-heart rounded-2xl blur opacity-30 dark:from-theme-heart dark:via-theme-paw dark:to-theme-nature" />
